let handler = async (m, { conn, args, text, usedPrefix, command, groupMetadata }) => {
let who 
...
await conn.reply(NumeroUser + '@s.whatsapp.net', `\`\`\`¡Hola! @${NumeroUser} Soy ${packname}, un Bot para WhatsApp. Parece que @${user} intentó agregarte al Grupo ${groupMetadata.subject} pero no pude hacerlo. No te preocupes, ¡aquí tienes una invitación para unirte!\n\n¡Te esperamos con ansias en el grupo!\`\`\`\n\n*${link}*`, m, {mentions: [NumeroUser + '@s.whatsapp.net', m.sender]})
