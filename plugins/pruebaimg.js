...
const handler = async (m, { conn, text }) => {
  ...
  const imageWidth = 3000 + Math.floor(formattedText.length / 100) * 200
  const imageHeight = Math.max(totalTextHeight + 100 + Math.floor(formattedText.length / 100) * 50, 1200)
