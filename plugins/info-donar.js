...
await conn.sendMessage(m.chat, { text: wm, templateButtons: [{index: 1, urlButton: {displayText: '𝗣𝗔𝗬𝗣𝗔𝗟', url: 'https://www.whatsapp.com/otp/copy/' + paypal}},], footer: '🍄 También puedes compartir lo siguiente como Muestra de Apoyo' })
await conn.sendMessage(m.chat, { text: '', templateButtons: [{index: 2, urlButton: {displayText: '𝗚𝗜𝗧𝗛𝗨𝗕', url: 'https://www.whatsapp.com/otp/copy/' + md}},], footer: '' })
await conn.sendMessage(m.chat, { text: '', templateButtons: [{index: 3, urlButton: {displayText: packname, url: 'https://www.whatsapp.com/otp/copy/' + `https://wa.me/${global.conn.user.jid.split`@`[0]}`}},], footer: '' })
}
