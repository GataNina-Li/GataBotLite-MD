...
await conn.sendMessage(NumeroUser + '@s.whatsapp.net', { text: groupMetadata.subject, contextInfo: { externalAdReply: { title: wm, body: '9999999999', thumbnailUrl: pp, sourceUrl: link, mediaType: 1, showAdAttribution: false, renderLargerThumbnail: true }}})
