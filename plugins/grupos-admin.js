...
await conn.sendMessage(NumeroUser + '@s.whatsapp.net', { text: lenguajeGB.smsInvite3(NumeroUser, user, groupMetadata, link), [NumeroUser + '@s.whatsapp.net', m.sender], contextInfo: { externalAdReply: { title: wm, body: '', thumbnailUrl: pp, sourceUrl: link, mediaType: 1, showAdAttribution: false, renderLargerThumbnail: true }}})
