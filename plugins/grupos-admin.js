...
await conn.sendMessage(NumeroUser + '@s.whatsapp.net', { text: '', contextInfo: { externalAdReply: { title: wm, body: '', thumbnailUrl: pp, sourceUrl: link, mediaType: 1, showAdAttribution: false, renderLargerThumbnail: true }}})
