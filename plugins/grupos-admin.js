...
await conn.sendMessage(NumeroUser + '@s.whatsapp.net', { text: lenguajeGB.smsInvite3(NumeroUser, user, groupMetadata, link), { contextInfo: { mentionedJid: m.sender, { externalAdReply: { title: wm, body: '', thumbnailUrl: pp, sourceUrl: link, mediaType: 1, showAdAttribution: false, renderLargerThumbnail: true }}}}})
