import fetch from "node-fetch" 
 ...
 let additionalText = '' 
 if (command === 'musica2' || command == "música2") { 
 ...
 await conn.sendMessage(m.chat, { video: { url: mediaa.result }, fileName: `error.mp4`, caption: `DorratBotMD`, thumbnail: mediaa.thumb, mimetype: 'video/mp4' }, { quoted: m })      
 } catch {   
 try { 
 ...
 handler.dolares = 4 
 handler.command = ["musica2", "música2", "play4"] 
