...
'https://tenor.com/es/view/anko-kitashirakawa-tamako-market-wave-hi-hello-gif-16396948',
...
let accion1 = `${conn.getName(m.sender)} está 👋 saludando a ${conn.getName(text.replace('@', '') + '@s.whatsapp.net')}
