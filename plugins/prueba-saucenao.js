...
let apiKey = "d3a88baf236200c2ae23f31039e599c252034be8"
const apiKeys = ["d3a88baf236200c2ae23f31039e599c252034be8"]//"45e67c4cbc3d784261ffc83806b5a1d7e3bd09ae", "d3a88baf236200c2ae23f31039e599c252034be8", "a74012c56b54b8d36d2675e12b1a216809c353fe",
...
try {*/
let response = await axios.get(`https://saucenao.com/search.php?db=999&output_type=2&testmode=1&numres=6&api_key=${apiKey}&url=${encodeURIComponent(url)}`);
/*success = true;
break;
} catch (error) {
//console.error(error);
