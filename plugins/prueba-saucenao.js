...
let enlace = { contextInfo: { externalAdReply: {title: wm, body: 'support group' , sourceUrl: nna, thumbnail: await(await fetch(primerResultado.header.thumbnail)).buffer() }}}
...
${resultadoEnBruto}`.trim(), null, [['𝗠 𝗘 𝗡 𝗨 ☘️', '/menu']], m, enlace)
} catch (e) {
