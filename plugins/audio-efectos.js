...
if (/blown/.test(command)) set = '-af "acrusher=.1:1:64:0:log,lowpass=f=4000,highpass=f=200,areverse,acrusher=.1:1:64:0:log,lowpass=f=4000,highpass=f=200,areverse"' //'-af "acrusher=.1:1:64:0:log,areverse,acrusher=.1:1:64:0:log,areverse"' //'-af acrusher=.1:1:64:0:log'
