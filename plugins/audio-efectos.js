...
if (/blown/.test(command)) set = '-af "acrusher=.1:1:64:0:log, lowpass=f=3000, highpass=f=200, equalizer=f=1000:width_type=h:width=50:g=6, areverse, acrusher=.1:1:64:0:log, lowpass=f=3000, highpass=f=200, equalizer=f=1000:width_type=h:width=50:g=6, areverse"' //'-af "acrusher=.1:1:64:0:log, lowpass=f=3000, highpass=f=200, volume=2, areverse, acrusher=.1:1:64:0:log, lowpass=f=3000, highpass=f=200, areverse"' //'-af "acrusher=.1:1:64:0:log, lowpass=f=3000, highpass=f=200, areverse, acrusher=.1:1:64:0:log, lowpass=f=3000, highpass=f=200, areverse"' //'-af "acrusher=.3:1:64:0:log, lowpass=f=2000, areverse, acrusher=.3:1:64:0:log, lowpass=f=2000, areverse"' //'-af "acrusher=.1:1:64:0:log, lowpass=f=8000, areverse, acrusher=.1:1:64:0:log, lowpass=f=8000, areverse"' //'-af "acrusher=.1:1:64:0:log,areverse,acrusher=.1:1:64:0:log,areverse"' //'-af acrusher=.1:1:64:0:log'
