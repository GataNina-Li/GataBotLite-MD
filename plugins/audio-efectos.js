...
if (/robot/.test(command)) set = '-af "rubberband=tempo=1.5:vocals=1"' //'-filter_complex "afftfilt=real=\'hypot(re,im)*sin(0)\':imag=\'hypot(re,im)*cos(0)\':win_size=512:overlap=0.75:volume=5dB"'
