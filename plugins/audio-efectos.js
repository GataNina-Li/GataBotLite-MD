...
if (/distortion/.test(command)) set = `-af "acompressor=threshold=0.1:ratio=3:attack=15:release=300,firequalizer=gain_entry='entry(1,100,6)+cubic(1,0)',biquad=type=notch:fc=250:width_type=h:width=50,gain=2"`//
