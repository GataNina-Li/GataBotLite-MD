...
if (/deep/.test(command)) set = '-af "atempo=4/4,asetrate=44500*2/3,rubberband=pitch=12,highpass=f=100,lowpass=f=15000,afftdn"' //'-af "rubberband=pitch=-200"'  //'-af atempo=4/4,asetrate=44500*2/3'
