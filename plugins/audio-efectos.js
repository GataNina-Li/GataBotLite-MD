...
if (/deep/.test(command)) set = '-af "atempo=4/4,asetrate=44500*2/3,highpass=f=100,lowpass=f=15000,treble=gain=6,areverse,treble=gain=6,lowpass=f=1000,highpass=f=500,compand=0.3:0.8:6:-60/-40/-30:-20/-20/-10:0:0:0"'  //'-af atempo=4/4,asetrate=44500*2/3'
