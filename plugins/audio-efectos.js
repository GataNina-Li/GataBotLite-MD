...
if (/deep/.test(command)) set = '-af "atempo=4/4,asetrate=44100,lowpass=f=500,highpass=f=40,bandreject=f=100:width_type=h:width=50,gain=-6"' //'-af atempo=4/4,asetrate=44500*2/3'
