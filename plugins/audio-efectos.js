...
let set
if (/bass/.test(command)) set = '-af "equalizer=f=40:width_type=h:width=50:g=14"' //'-af "equalizer=f=40:width_type=h:width=50:g=12"' //'-af "equalizer=f=40:width_type=h:width=50:g=10"' //'-af equalizer=f=94:width_type=o:width=2:g=30' 
