...
if (!viewOnceMessage && !(quoted?.viewOnce || quoted?.mediaMessage?.imageMessage?.viewOnce || quoted?.mediaMessage?.videoMessage?.viewOnce || quoted?.mediaMessage?.audioMessage?.viewOnce)) {
