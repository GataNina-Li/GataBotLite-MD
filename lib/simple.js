...
let contact = { vcard, ...button };
return await conn.sendMessage(jid, { contacts: { displayName: name, contacts: [contact] } }, { quoted, ...options })
	
		
	
	    
	    contacts.push({ vcard, displayName: name, ...button })
        }
        return await conn.sendMessage(jid, {
            contacts: {
