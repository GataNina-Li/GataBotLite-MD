...
async value(jid, text = '', quoted, options, m) {
const contieneWhatsAppNet = /@s\.whatsapp\.net$/i.test(jid)
let user = global.db.data.users[contieneWhatsAppNet]
//await realizarOperacionPrioritaria(user)
//let idioma = ''
//if (jid) {
...
/*function realizarOperacionPrioritaria(user) {
return new Promise((resolve, reject) => {
const contieneWhatsAppNet = /@s\.whatsapp\.net$/i.test(jid)
if (contieneWhatsAppNet) {
...
//if (user.GBLanguage) {
//if (idiomasPermitidos.hasOwnProperty(user.GBLanguage)) {
//global.lenguajeGB = idiomasPermitidos[user.GBLanguage] 
//}}
//global.lenguajeGB = idiomasPermitidos[user.GBLanguage] || es
//}
if (user.GBLanguage == 'es') {
global.lenguajeGB = es
} else if (user.GBLanguage == 'en') {
