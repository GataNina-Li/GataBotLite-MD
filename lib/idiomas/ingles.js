...
const smsMalused3 = () => { return `${lenguajeGB['smsAvisoMG']()}🐈 *YOU MUST USE THE COMMAND OR RESPOND TO SOMEONE'S MESSAGE LIKE IN THIS EXAMPLE:*\n`}
...
const smsBlockUn2 = (comd, ownerNumber) => { return lenguajeGB.smsAvisoMG() + `*CAN'T ${comd} TO THE OWNER @${ownerNumber}*`}
