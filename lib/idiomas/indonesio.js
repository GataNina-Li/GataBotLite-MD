...
const methodCode11 = () => { return ` NOMOR SELAIN TIDAK BOLEH DIPERBOLEHKAN ${chalk.bold.greenBright("1")} O ${chalk.bold.greenBright("2")}, TIDAK ADA SURAT ATAU SIMBOL KHUSUS.\n${chalk.bold.yellowBright(" TIPS: SALIN NOMOR OPSI DAN TEMPEL KE KONSOL.")}` }
