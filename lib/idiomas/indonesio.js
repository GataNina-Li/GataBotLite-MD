...
const smsMalused3 = () => { return `${lenguajeGB['smsAvisoMG']()}🐈 *ANDA HARUS MENGGUNAKAN PERINTAH ATAU MERESPON PESAN SESEORANG SEPERTI DI CONTOH INI:*\n`}
...
const smsBlockUn2 = (comd, ownerNumber) => { return lenguajeGB.smsAvisoMG() + `*TIDAK BISA ${comd} KEPADA PEMILIK @${ownerNumber}*`}
...
smsMenuTotal10, smsMenuTotal11, smsMenuTotal12, smsMalused, smsMalused2, smsMalused3, smsMalError, smsMalError2, smsMalError3 }
