...
const smsVerify8 = (usedPrefix) => { return `*SU ID DE REGISTRO SERVIRÁ EN CASO QUE DESE MODIFICAR O ELIMINAR SU REGISTRO USANDO ${usedPrefix}unreg*`}
...
smsVerify3, smsVerify4, smsVerify5, smsVerify6, smsVerify7, smsVerify8, smsVerify9};
