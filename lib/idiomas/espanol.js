...
const languageRegisterr = (selectedLanguage) => { return `❇️ Se ha configurado el idioma como "${selectedLanguage}".\n`} 
...
smsAutodetec3, smsAutodetec4, smsAutodetec5, smsAutodetec6, smsAutodetec7, smsImageGg, smsGit, languageSave, languageRegisterr }
