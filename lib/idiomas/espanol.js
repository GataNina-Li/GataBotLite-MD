...
//info-creadora.js
const smsCreNombre = () => { return 'NOMBRE'}
const smsCreNum = () => { return 'NÚMERO'}
const smsCreContag = () => { return 'CONTACTO'}
const smsCreGrupos = () => { return 'GRUPOS'}
const smsCreDonar = () => { return 'DONAR'}
const smsCreCuenta = () => { return 'CUENTAS'}
const smsCreInstall = () => { return 'INSTALACIÓN'}
const smsCreInfoBot = () => { return 'SOBRE ' + packname}
const smsCreInfo = () => { return '🌟 I N F O R M A C I Ó N '}
const smsCreApoyo = () => { return '✨ A P O Y O'}
const smsCreDesc = () => { return '🌼 *_SELECCIONE QUE QUIERE SABER_*'}
const smsCreSelec = () => { return '🌹 SELECCIONAR AQUÍ 🌹'}
...
//info-instalar_GataBotLite.js
const smsInsTexto = () => { return '*◎ SELECCIONE EL TIPO DE INSTALACIÓN:*'}
const smsInsTermux = () => { return '_◊ Puedes visitar el repositorio o Copiar los comandos de instalación._'}
const smsInsComandos = () => { return 'C O M A N D O S'}
const smsInsReplit = () => { return '_◊ Cree su cuenta en Replit, si ya tiene cuenta use el tercer Botón._'}
const smsInsCrear = () => { return 'C R E A R  C U E N T A'}
const smsInsHeroku = () => { return '_◊ Cree su cuenta en Heroku, si ya tiene cuenta use el segundo Botón._'}
...
const smsLisF = () => { return '*⋄ Bot Admin:*'}
...
const smsBT9 = () => { return 'MÁS INFORMACIÓN'}
const smsBT10 = () => { return 'LISTA DE GRUPOS'}
const smsBT11 = () => { return 'SUB BOTS ACTIVOS'}
const smsBT12 = () => { return 'C O N T A C T O'}
...
lenguaje, smsAvisoRG, smsAvisoAG, smsAvisoIIG, smsAvisoFG, smsAvisoMG, smsAvisoEEG, smsAvisoEG, smsRowner, smsOwner, smsMods, smsPremium, smsGroup, smsPrivate, smsAdmin, smsBotAdmin, smsUnreg, smsRestrict, smsWelcome, smsBye, smsSpromote, smsSdemote, smsSdesc, smsSsubject, smsSicon, smsSrevoke, smsConexion, smsClearTmp, smsCodigoQR, smsConexionOFF, smsCargando, smspurgeSession, smspurgeOldFiles, smspurgeSessionSB1, smspurgeSessionSB2, smspurgeSessionSB3, smspurgeOldFiles1, smspurgeOldFiles2, smspurgeOldFiles3, smspurgeOldFiles4, smsConMenu, smsCreNombre, smsCreNum, smsCreContag, smsCreGrupos, smsCreDonar, smsCreCuenta, smsCreInstall, smsCreInfoBot, smsCreInfo, smsCreApoyo, smsCreDesc, smsCreSelec, smsCreA,
smsCreB, smsCreC, smsOfc1, smsOfc2, smsMensajeDonar, smsTituloDonar, smsPrivadoDonar, smsGrupoOfc1, smsGrupoOfc2, smsInsTexto, smsInsTermux, smsInsComandos,
smsInsReplit, smsInsCrear, smsInsHeroku, smsLisA, smsLisB, smsLisC, smsLisD, smsLisE, smsLisF, smsEstado1, smsEstado2, smsEstado3, smsEstado4, smsEstado5,
smsEstado6, smsEstado7, smsVl1, smsVl2, smsVl3, smsVl4, smsVl5, smsVl6, smsBT1, smsBT2, smsBT3, smsBT4, smsBT5, smsBT6, smsBT7, smsBT8, smsBT9, smsBT10, smsBT11,
smsBT12, smsYT1, smsYT2, smsYT3, smsYT4, smsYT5, smsYT6, smsYTA1, smsContacto1, smsContacto2, smsContacto3, smsContacto4, smsContacto5, smsContacto6, smsContacto7,
...
smstagaa, smsInsGC1, smsInsGC2, smsInsGC3, smsInsGC4, smsInsGC5 };
