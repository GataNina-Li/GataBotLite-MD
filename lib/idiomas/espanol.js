...
const smsJBDifu2 = (numUser, difuUser, tolUser) => { return `*Difusión enviada con éxito a ${numUser} sub bots*\n\n${difuUser}\n*Se finalizo con el envió en ${tolUser} segundos*`}
...
smsJBCerrarS, smsFoldErr, smsJBCom1, smsJBCom2, smsJBCom3, smsJBCom4, smsJBDifu1, smsJBDifu2 };
