...
//convertidores.js
const smsConURL = () => { return lenguajeGB.smsAvisoMG() + '*RESPONDA A STICKER EN MOVIMIENTO PARA CONVERTIR A VÍDEO*'} 
const smsConURL2 = () => { return lenguajeGB.smsAvisoMG() + '*SÓLO STICKER EN MOVIMIENTO PARA CONVERTIR A VÍDEO*'} 
const smsConURL3 = () => { return lenguajeGB.smsAvisoEG() + '*✓ AQUÍ TIENES TÚ VÍDEO!!*'} 
...
smsConURL, smsConURL2, smsConURL3, smsConGIF, smsConGIF2, smsConGIF3};
