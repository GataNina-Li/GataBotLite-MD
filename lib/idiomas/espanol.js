...
const smsJoin1 = (usedPrefix, command) => { return lenguajeGB['smsAvisoEG']() + `*INGRESE EL ENLACE DE UN GRUPO*\n*EJEMPLO:*\n*${usedPrefix + command}* ${nna}`}
const smsJoin2 = () => { return lenguajeGB['smsAvisoEG']() + `*${packname} SE HA UNIDO AL GRUPO ✅*`}
...
smsRestarU1, smsRestarU2, smsRestarU3, smsJoin1, smsJoin2 };
