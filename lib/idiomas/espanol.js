...
const languageRegister = (selectedLanguage) => { return `❇️❇️❇️ Se ha configurado el idioma como "${selectedLanguage}".\n`} 
...
smsAutodetec3, smsAutodetec4, smsAutodetec5, smsAutodetec6, smsAutodetec7, smsImageGg, smsGit, languageSave, languageRegister}

/*let file = fileURLToPath(import.meta.url)
watchFile(file, () => {
unwatchFile(file)
console.log(chalk.bold.greenBright("SE ACTUALIZÓ 'lib folder' CON ÉXITO".trim()))
