...
const smsPropban3 = (ownerNumber) => { return `*NO PUEDO BANEAR AL OWNER @${ownerNumber} DE ${packname}*`}
const smsPropban4 = (number) => { return `*NO ES NECESARIO VOLVER A BANEAR A @${number} SI YA LO ESTÁ*`}
const smsPropban5 = () => { return `*USUARIO BANEADO CON ÉXITO*`}
