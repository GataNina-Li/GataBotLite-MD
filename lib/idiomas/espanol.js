...
//config-on y off.js
const smsConfi1 = () => { return `⚙️ *CONFIGURACIÓN* ⚙️`}
const smsConfi2 = () => { return `COMANDO`}
const smsConfi3 = () => { return `ESTADO`}
const smsConfi4 = () => { return `PARA`}
const smsConfi5 = () => { return `ACTIVADO`}
const smsConfi6 = () => { return `DESACTIVADO`}
const smsConfi7 = () => { return `ESTE CHAT`}
...
smsBCbot1, smsBCbot2, smsBCbot3, smsBCbot4, smsBCbot5, smsBCbot6, smsBCbot7, smsBCMensaje, smsBCMensaje2, smsBCMensaje3, smsConfi1, smsConfi2, smsConfi3, smsConfi4,
smsConfi5, smsConfi6, smsConfi7, smsTextoYT, smsApagar, smsEncender, smsEnlaceTik, smsEnlaceYt, smsEnlaceTel, smsEnlaceFb, smsEnlaceIg, smsEnlaceTw, smsAllAdmin, smsSoloOwner,
smsAdwa, smsEnlaceWat, smsEnlaceWatt }
